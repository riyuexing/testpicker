				...
				<div class="panel panel-custom">
					...
					<div class="panel-heading">
						...
						@if ($user->subscription_ends_at != null)
							<a href="{{ route('subscription.list') }}" class="btn btn-primary pull-right">Extend Subscription</a>
						@else
							<a href="{{ route('subscription.list') }}" class="btn btn-primary pull-right">Get Subscription</a>
						@endif
