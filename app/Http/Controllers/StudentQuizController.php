...
class StudentQuizController extends Controller
{
  ...
  $user_record->notify(new \App\Notifications\StudentExamResult($user_record,$exam_status,$quiz->title,$quiz->pass_percentage)); 
    ...
    {   
           ...
           if (Auth::user()->subscription_ends_at == null) {
              return '<div class="dropdown more">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li><a  href="'.SUBSCRIPTION_LIST.'"><i class="fa fa-pencil"></i>'.getPhrase("take_exam").'</a></li>
        ...
        {
        $status =  '<span class="label label-primary">'.getPhrase('paid') .'</span>';
          return $status;
        ...
        ->editColumn('title', function($records) 
        {
          ...
          if (Auth::user()->subscription_ends_at == null) {
            return '<a href="'.SUBSCRIPTION_LIST.'">'.$records->title.'</a>';
          }
   ...
   public function showSubscriptionList(){
        ...
        //     flash('Opsss !!!','You Already Have Subscription','error');
