   ...
   protected $dates = ['trial_ends_at', 'subscription_ends_at'];
    ...
    { 
     ...
     public function subscriptionStatus(){
        $user = Auth::user();
        $subscription_expiry = Carbon::parse($user->subscription_ends_at);
        $currentTime = Carbon::now();
        if($currentTime->gte($subscription_expiry)){
        User::where('id', $user->id)->update(['subscription_ends_at' => null]);
        }
     }
