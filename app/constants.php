...
define('DASHBOARD', PREFIX.'dashboard');
...
define('SUBSCRIPTION_LIST', PREFIX.'payments/subscription');
...
define('SUBSCRIPTION_PLAN', PREFIX.'payments/checkout/subscription/');
define('SIX_MONTH_SUBSCRIPTION', PREFIX.'payments/checkout/subscription/six-month');
define('ONE_YEAR_SUBSCRIPTION', PREFIX.'payments/checkout/subscription/one-year');
