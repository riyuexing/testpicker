...
Route::get('payments/subscription', 'PaymentsController@showSubscriptionList')->name('subscription.list');

//Email activation link
Route::get('user/email/activate/{confirm_code}', 'VarificationController@emailVarify');
Route::post('user/resend/verification/link', 'VarificationController@resendVerificatinLink');
