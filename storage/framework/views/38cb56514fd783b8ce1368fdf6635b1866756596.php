    ...
    <div class="container">
        ...
        <br>
                    ...
                    <ul class="login-links mt-2">
                         ...
                         <ul class="login-links mt-2">
                               <li> <a href="javascript:void(0);" data-toggle="modal" data-target="#resendVarificationLink" ><i class="icon icon-question"></i> <?php echo e(getPhrase('verification_link')); ?></a></li>
...
<div id="resendVarificationLink" class="modal fade" role="dialog">

  <div class="modal-dialog">

  <?php echo Form::open(array('url' => RESEND_VARIFICATION_LINK, 'method' => 'POST', 'name'=>'formLanguage ', 'novalidate'=>'', 'class'=>"loginform", 'name'=>"passwordForm")); ?>
