...
<?php if(Auth::user()->otp_form == 1): ?>
    ...
    <p>Change Mobile Number <a href="<?php echo e(route('change.phone')); ?>"  >Click Me</a></p>
    <p>Resend Otp <a href="<?php echo e(route('verify.phone')); ?>" >Click Me</a></p>
<?php endif; ?>
</div>
</div>
</div>
