                  ...
                  <?php endif; ?>
					...
					<fieldset class="form-group">
						...
						<span class="text-red">*</span>
						<?php if(Auth::user()->phone_verify == 0 && Auth::user()->phone): ?>

							<p><b>Please verify your phone number </b><a href="<?php echo e(route('verify.phone')); ?>" class="btn btn-success">Send Otp</a></p>
						<?php endif; ?>
