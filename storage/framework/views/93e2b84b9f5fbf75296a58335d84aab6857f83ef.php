        ...
        <div class="cs-topbar">
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right" style="margin-top: 5px;">
                    ...
                    <li><a href="<?php echo e(DASHBOARD); ?>" class="cs-nav-btn visible-lg"> <?php echo e(getPhrase('dashboard')); ?></a></li>
        ...
        <div class="container">
            ...
            <div class="navbar-offcanvas navbar-offcanvas-touch" id="js-bootstrap-offcanvas">
                ...
                <ul class="nav navbar-nav navbar-left navbar-main myheader">
                    ...
                    <?php if(Auth::check()): ?>
                        <li <?php echo e(isActive($active_class, 'dashboard')); ?> ><a href="<?php echo e(DASHBOARD); ?>"><?php echo e(getPhrase('dashboard')); ?></a></li>
                    <?php endif; ?>
                    ...
                    <li <?php echo e(isActive($active_class, 'subscription_plan')); ?> ><a href="<?php echo e(SITE_SUBSCRIPTION_PLAN); ?>"><?php echo e(getPhrase('subscription_plan')); ?></a></li>
                    ...
                    <li <?php echo e(isActive($active_class, 'contact-us')); ?> ><a class="color" href="<?php echo e(URL_SITE_CONTACTUS); ?>"><?php echo e(getPhrase('contact_us')); ?></a></li>
