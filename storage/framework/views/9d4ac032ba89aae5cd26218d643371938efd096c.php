...
<section class="availabe-cource">
   <h2 class="cs-section-head text-center"><?php echo e(getPhrase('available_cources')); ?></h2>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card" style="width: 20rem;">
                    <div class="card-body">
                        <p class="card-icon">
                            <img src="<?php echo e(EXAM_CATEGORY_PATH.$subCat->getCategory->image); ?>" alt="image" class="card-image">
                        </p>
                        <h3 class="text-center font-weight-bold" style="color: #4786ff"><?php echo e($subCat->sub_category); ?></h3>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
