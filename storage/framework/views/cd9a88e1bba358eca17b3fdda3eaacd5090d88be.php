				...
				<div class="panel panel-custom" ng-init="initAngData(<?php echo e($settings); ?>);" >
					...
					<?php $button_name = getPhrase('create'); ?>
							...
							<fieldset class="form-group col-md-6">
								...
								<?php echo e(Form::select('subject', $subjects, null, ['class'=>'form-control', 'ng-model' => 'subject_id', 'placeholder' => 'Select', 'ng-change'=>'subjectChanged(subject_id)' ])); ?>
							...
							<fieldset class="form-group col-md-6">
								...
								<?php echo e(Form::select('topic', $topics, null, ['class'=>'form-control', 'ng-model' => 'topic', 'placeholder' => 'Select' ])); ?>
							...
							<div ng-if="subjectQuestions!=''" class="vertical-scroll" >
								...
								<table  
								  ...
								  class="table table-hover">
									...
									<th><?php echo e(getPhrase('if_added')); ?></th>
