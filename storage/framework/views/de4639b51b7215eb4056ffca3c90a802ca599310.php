...
<a  href="<?php echo e(URL_MESSAGES); ?>"> <i class="fa fa-fw fa-comments" aria-hidden="true"> </i>
					...
					<li <?php echo e(isActive($active_class, 'setting')); ?> > 

						<a href="<?php echo e(URL_USERS_SETTINGS.Auth::user()->slug); ?>" ><i class="fa fa-cog" aria-hidden="true"></i>

					<?php echo e(getPhrase('Account Setting')); ?> </a> 
